(function e(t, n, r) {
...
})(
  {
	...
	*/
        ...
        function Timeliner(target, callBackUpdateTime) {
          ...
          // add_by_myself
          this._out_data = data;
          function addKeyFrame(layer_index, t, value) {
            dispatcher.fire("keyframe", layers[layer_index], value, t);
          }
          this.addKeyFrame = addKeyFrame;

          // var callback_timeUpdate =  function(){console.log("dd");};
          // this.callback_timeUpdate = function(){console.log("dd");};
          ...
          dispatcher.on("keyframe", function (layer, value, x = -1) {
	...
	*/
    ...
    9: [
      ...
      { "./theme": 5, "./util_handle_drag": 13, "./utils": 16, "do.js": 1 },
    ],
    10: [
      function (require, module, exports) {
...
*/
    ...
    11: [
      ...
      { "../package.json": 2, "./settings": 4, "do.js": 1 },
    ],
    12: [
      function (require, module, exports) {
        /**************************/
	...
	*/
          ...
          function convertPercentToTime(t) {
            ...
            var max_time = 1;
            var v =
              (Settings.width * 0.8) / (t * (max_time - min_time) + min_time);
            return v;
          }
          ...
          function convertTimeToPercent(v) {
            ...
            var max_time = 1;
            var t =
              ((Settings.width * 0.8) / v - min_time) / (max_time - min_time);
            return t;
          }
        ...
        function TimelinePanel(data, dispatcher) {
          ...
          function drawLayerContents() {
            ...
            for (i = 0, il = layers.length; i <= il; i++) {
              ...
              ctx_wrap.moveTo(0, y).lineTo(width, y).stroke();
            }
    ...
    20: [
      ...
      { "./theme": 5, "./util_handle_drag": 13, "./utils": 16 },
    ],
  },
  {},
  [6]
